...
![Demo of Prism API](docs/images/demo-v1.1.0-SNAPSHOT.gif)
...
```groovy
def prism_version = "master-SNAPSHOT" // Replace with the version you want (e.g., v1.0.0 or master-SNAPSHOT)
