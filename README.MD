...
| Version                       | Description                              |
|-------------------------------|------------------------------------------|
| [v1.0.0](changelogs/1.0.0.MD) | The first official release of Prism API. |
| [v1.0.1](changelogs/1.0.1.MD) | Various 3D rendering functions.          |

## 🔨 Demo of the latest version
![Demo of Prism API](images/demo-v1.0.1.gif)
